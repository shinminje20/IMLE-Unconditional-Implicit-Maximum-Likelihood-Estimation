...
def create_dataset(dataset_opt):
    ...
    elif mode == 'LRHR_four_levels_double':
        from data.LRHR_four_levels_double_dataset import LRHRFourLevelsDoubleDataset as D
    elif mode == 'Co_four_levels':  # progressive colorization, 4 levels, target is high-resolution color images

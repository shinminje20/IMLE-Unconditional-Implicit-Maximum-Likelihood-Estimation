"""Modified from original CAMNet utils.py:

https://github.com/niopeng/CAM-Net/blob/main/code/data/util.py
...
def is_image_file(filename):
    """Returns if [filename] is an image file."""
    return any(filename.endswith(extension) for extension in IMG_EXTENSIONS)


def _get_paths_from_images(path):
    """Returns a list of image paths that are hierarchically below [path]."""
